...
if __name__ == '__main__':
    ...
    file = ['cache/survey_dataset.csv', 'cache/annual_salary_adjusted_by_location_and_age.csv', 'cache/annual_salary_adjusted_by_location_and_education.csv']
    for file in files:
        obj = file.replace('cache/', '')
        upload_file(file, 'ist356mafudge', obj)